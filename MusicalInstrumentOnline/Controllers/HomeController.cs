    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index([Bind("name,email,spicalNote")] Contact contact)
        {
            if (HttpContext.Session.GetInt32("id") != null)
            {
                ...
                {
                    string? cs1 = _configuration.GetConnectionString("ConnectionName");
                    SqlConnection con1 = new SqlConnection(cs1);
                    SqlCommand cmd1 = new SqlCommand("insert into Contact values(\'" + contact.name + "\',\'" + contact.email + "\',\'" + contact.spicalNote + "\')", con1);
                    con1.Open();
